    ...
    public:
        ...
        std::string cardHtml(int item_number) const override
        {
            ...
            os << "<article class=\"product-card\">\n"
                  ...
                  "    <p>Surfacing: " << surf << "</p>\n"
                  "    <p class=\"price\">$" << dollars(price_ft) << " / ft</p>\n"
                  "  </div>\n"
                  "</article>\n";
            return os.str();
        }
        ...
        WwhgBoard(int id_, std::string species_, std::string size_,
                  unsigned len_ft, WWhgLumberFinish surf, double price, std::optional<std::string> imagePath = std::nullopt)
