// =====================================================================================================================
//  slab_manufacturer.hpp — Geometry & workflow helper (header‑only)
// =====================================================================================================================
#pragma once
/**
 * @file slab_manufacturer.hpp
 * @brief Header‑only helper for planning live‑edge slab cuts and committing them to Slab objects.
 *
 * Geometry helpers remain inline for maximum performance; finalize() lives in *slabs.cpp* because it
 * touches persistence.
 */
...
#include "live_edge_slabs.hpp"   // Slab declaration
...
// finalize() is declared in slab_manufacturer.hpp but defined in slabs.cpp because it depends on Slab persistence
