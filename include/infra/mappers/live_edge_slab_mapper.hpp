...
namespace woodworks::domain {
    ...
    {
        return "INSERT INTO live_edge_slabs (species, length, width, thickness, drying, location, notes) VALUES (:species, :length, :width, :thickness, :drying, :location, :notes)";
    }

    inline QString LiveEdgeSlab::updateSQL()
    {
        return "UPDATE live_edge_slabs SET species = :species, length = :length, width = :width, thickness = :thickness, drying = :drying, location = :location, notes = :notes WHERE id = :id";
    }
